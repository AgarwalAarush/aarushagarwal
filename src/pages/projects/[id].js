              ...
              {project.icon ? (
                <div className="flex items-center gap-4 mb-4">
                  <Image
                    ...
                    className="rounded-lg flex-shrink-0"
                  />
                  <h1 className="text-2xl font-bold text-gray-900 dark:text-white m-0">{project.title}</h1>
                </div>
              ) : (
              ...
              {project.technologies && (
                <div className="flex flex-wrap mb-6 gap-2">
                  {project.technologies.map((tech, index) => (
                    <span 
                      key={index} 
                      className="px-3 py-1 text-sm font-medium rounded-sm bg-gray-100 text-gray-700 dark:bg-[#181818] dark:text-white border border-gray-200 dark:border-transparent"
                    >
                      {tech}
                    </span>
                  ))}
