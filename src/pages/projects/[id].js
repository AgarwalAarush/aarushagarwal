                  ...
                  <div className="flex space-x-6">
                    {project.github && (
                      <a
                        ...
                        className="inline-flex items-center px-4 py-2 text-sm  border border-[#162338] text-[#162338] rounded-lg hover:bg-[#162338] hover:text-white transition-colors duration-300"
                      >
