				...
				<h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">Key Achievements</h2>
					<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
						{achievements.map((achievement, index) => (
							<motion.div
								key={index}
							className="bg-gray-100 dark:bg-gray-800/30 rounded-lg p-6 border border-gray-200 dark:border-gray-700/50"
			...
			<section>
				...
				<div className="bg-gray-100 dark:bg-gray-800/30 rounded-lg p-6 border border-gray-200 dark:border-gray-700/50">
					<p className="text-gray-700 dark:text-gray-300 mb-6">
						...
						<a href="https://github.com/agarwalaarush" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 px-4 py-2 border border-gray-300 text-gray-700 hover:text-gray-900 dark:border-gray-500 dark:text-gray-300 dark:hover:text-white hover:border-gray-400 rounded-md transition-colors duration-200">
