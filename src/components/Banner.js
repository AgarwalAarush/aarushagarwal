...
export default function Banner({ banners }) {
    ...
    if (!mounted || !isVisible || !banners || banners.length === 0) {
        return null;
    }
                ...
                >
                    <div className="relative group bg-gray-100 dark:bg-gray-800/30 border border-gray-200 dark:border-gray-700/50 rounded-lg p-4 hover:border-gray-300 dark:hover:border-gray-600 transition-all duration-200">
                        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 pr-8">
                            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between sm:justify-evenly gap-3 flex-1 w-full">
                                {banners.map((banner) => (
